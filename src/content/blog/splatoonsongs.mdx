...
<ins class="edit" datetime="2025-11-15">
    2025-11-15 Update:<br />
    I made the stinky csv loader it sucks so bad but it works. I had to switch
    to using MDX but. yay.
</ins>

import Csv from "@components/Csv.astro";

<Csv filePath="public/songpoll.csv" alignRight={["Place", "Wins", "Losses", "% Won"]} />
